    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "High-speed internet access available throughout the hotel", "Free Wi-Fi" },
                    { 2, "Outdoor pool with a temperature-controlled environment", "Swimming Pool" },
                    { 3, "Fully equipped gym with modern exercise machines and weights", "Fitness Center" },
                    { 4, "Round-the-clock dining service with a variety of cuisines", "24/7 Room Service" }
                });
            ...
            migrationBuilder.InsertData(
                table: "RoomClasses",
                columns: new[] { "Id", "AdultsCapacity", "ChildrenCapacity", "Description", "Name", "PricePerNight" },
                values: new object[,]
                {
                    { 1, 6, 2, "A cozy room with basic amenities", "Standard Room", 100m },
                    { 2, 7, 3, "Spacious room with a view and premium features", "Deluxe Room", 150m },
                    { 3, 12, 5, "Perfect for families, includes a separate area", "Family Suite", 250m },
                    { 4, 5, 2, "Luxurious suite with a workspace and lounge", "Executive Suite", 300m },
                    { 5, 2, 0, "Compact room ideal for solo travelers", "Single Room", 80m },
                    { 6, 2, 0, "Room with two single beds, great for friends", "Twin Room", 120m }
                });
            ...
            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "Id", "CreatedAt", "HotelId", "IsAvailable", "RoomClassId" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, true, 5 },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, true, 4 },
                    { 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, true, 2 },
                    { 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, true, 6 }
                });
